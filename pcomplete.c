...
ITEMLIST it_aliases = { 0, it_init_aliases, (STRINGLIST *)0, 0, 0 };
ITEMLIST it_arrayvars  = { LIST_DYNAMIC, it_init_arrayvars, (STRINGLIST *)0, 0, 0 };
ITEMLIST it_bindings  = { 0, it_init_bindings, (STRINGLIST *)0, 0, 0 };
ITEMLIST it_builtins  = { 0, it_init_builtins, (STRINGLIST *)0, 0, 0 };
ITEMLIST it_commands = { LIST_DYNAMIC, 0, 0, 0, 0 };	/* unused */
ITEMLIST it_directories = { LIST_DYNAMIC, 0, 0, 0, 0 };	/* unused */
ITEMLIST it_disabled = { 0, it_init_disabled, (STRINGLIST *)0, 0, 0 };
ITEMLIST it_enabled = { 0, it_init_enabled, (STRINGLIST *)0, 0, 0 };
ITEMLIST it_exports  = { LIST_DYNAMIC, it_init_exported, (STRINGLIST *)0, 0, 0 };
ITEMLIST it_files = { LIST_DYNAMIC, 0, 0, 0, 0 };		/* unused */
ITEMLIST it_functions  = { 0, it_init_functions, (STRINGLIST *)0, 0, 0 };
ITEMLIST it_helptopics  = { 0, it_init_helptopics, (STRINGLIST *)0, 0, 0 };
ITEMLIST it_hostnames  = { LIST_DYNAMIC, it_init_hostnames, (STRINGLIST *)0, 0, 0 };
ITEMLIST it_groups = { LIST_DYNAMIC, 0, 0, 0, 0 };		/* unused */
ITEMLIST it_jobs = { LIST_DYNAMIC, it_init_jobs, (STRINGLIST *)0, 0, 0 };
ITEMLIST it_keywords = { 0, it_init_keywords, (STRINGLIST *)0, 0, 0 };
ITEMLIST it_running = { LIST_DYNAMIC, it_init_running, (STRINGLIST *)0, 0, 0 };
ITEMLIST it_services = { LIST_DYNAMIC, 0, 0, 0, 0 };	/* unused */
ITEMLIST it_setopts = { 0, it_init_setopts, (STRINGLIST *)0, 0, 0 };
ITEMLIST it_shopts = { 0, it_init_shopts, (STRINGLIST *)0, 0, 0 };
ITEMLIST it_signals = { 0, it_init_signals, (STRINGLIST *)0, 0, 0 };
ITEMLIST it_stopped = { LIST_DYNAMIC, it_init_stopped, (STRINGLIST *)0, 0, 0 };
ITEMLIST it_users = { LIST_DYNAMIC, 0, 0, 0, 0 };		/* unused */
ITEMLIST it_variables = { LIST_DYNAMIC, it_init_variables, (STRINGLIST *)0, 0, 0 };
